...
int main()
{
    ...
    g.InsertEdge(g.GetNode(0), g.GetNode(1), 1, 1);            g.InsertEdge(g.GetNode(0), g.GetNode(2), 2, 1);      g.InsertEdge(g.GetNode(1), g.GetNode(3), 5, 1);
    g.InsertEdge(g.GetNode(2), g.GetNode(4), 1, 1);            g.InsertEdge(g.GetNode(4), g.GetNode(5), 1, 1);      g.InsertEdge(g.GetNode(3), g.GetNode(5), 1, 1);
    /*
